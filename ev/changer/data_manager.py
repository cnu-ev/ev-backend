...
class Data_manager:
    preprocessed_train_text_dir = '/home/radi/ev-backend/ev/changer/data_set_to_pickle/preprocessed_text_train.pkl'
    preprocessed_test_text_dir = '/home/radi/ev-backend/ev/changer/data_set_to_pickle/preprocessed_text_test.pkl'
    def __init__(self):
